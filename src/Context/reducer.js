export const actionType = {
  ...
  SET_ALL_SUGGESTED_SONGS: "SET_ALL_SUGGESTED_SONGS",
  SET_SUGGESTED_SONG: "SET_SUGGESTED_SONG",
...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case actionType.SET_YEAR_FILTER:
      return {
        ...state,
    ...
    case actionType.SET_ALL_SUGGESTED_SONGS:
      return {
        ...state,
        allSuggestedSongs: action.allSuggestedSongs,
      };
    ...
    case actionType.SET_SUGGESTED_SONG:
      return {
        ...state,
        suggestedSong: action.suggestedSong,
      };
