...
import { updateRole, getAllUsers, removeUser } from "../../../api";
...
const DashboardUserCard = ({ data, index }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-base text-textColor w-225 min-w-[160px] text-center">
        {data?.name}
      </p>
      <p className="text-base text-textColor w-225 min-w-[160px] text-center">
        {data?.email}
      ...
      <div className=" w-225 min-w-[160px] text-center flex items-center justify-center gap-6 relative">
